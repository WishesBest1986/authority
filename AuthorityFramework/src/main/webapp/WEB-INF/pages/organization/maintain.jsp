    ...
    <script>
        $(function() {
            $("#updateBtn").click(function() {
                $("#form")
                        .attr("action", "${pageContext.request.contextPath}/organization/${organization.id}/update.do")
                        .submit();
                return false;
            });
            $("#deleteBtn").click(function() {
                if(confirm("确认删除吗？")) {
                    $("#form")
                            .attr("action", "${pageContext.request.contextPath}/organization/${organization.id}/delete.do")
                            .submit();
                }
                return false;
            });
            ...
            $("#appendChildBtn").click(function() {
                location.href="${pageContext.request.contextPath}/organization/${organization.id}/appendChild.do";
                return false;
            });

            $("#moveBtn").click(function() {
                location.href="${pageContext.request.contextPath}/organization/${organization.id}/move.do";
                return false;
            });
        });
    </script>
