...
<html>
  <head>
    ...
    <script type="text/javascript" src="${ctx}/styles/js/table.js"></script>
  </head>
  <body>
    <form action="${ctx}/security/user" method="get" id="mainForm">
      <input type="hidden" name="pageNo" id="pageNo" value="${page.pageNo}" />
      <input type="hidden" name="orderBy" id="orderBy" value="${page.orderBy}" />
      <input type="hidden" name="order" id="order" value="${page.order}" />
      <table width="100%" border="0" align="center" cellpadding="0" class="table_all_border"
             cellspacing="0" style="margin-bottom: 0px;border-bottom: 0px">
        <tr>
        ...
        <tr>
          <td align="left">
            <shiro:hasPermission name="USEREDIT">
              <input type="button" onblur="addNew('${ctx}/security/user/create')" class="button_70px" value="新建" />
            </shiro:hasPermission>
      ...
      <table class="table_all" align="center" border="0" cellpadding="0" cellspacing="0">
        ...
        <frame:page totalRecords="${page.totalCount}" totalPages="${page.totalPages}" curPage="${page.pageNo}" lookup="${lookup}" />
      </table>
    </form>
  </body>
</html>