...
public class MenuService {
    ...
    public List<Menu> getAllowedAccessMenu(Long userId) {
        ...
        sqlBuffer.append(" select m.id,m.name,m.parent_menu,m.description,m.order_num from sec_menu m ");
        ...
        sqlBuffer.append(" select m.id,m.name,m.parent_menu,re.source as description,m.order_num from sec_resource re ");
        ...
        sqlBuffer.append(" select m.id,m.name,m.parent_menu,re.source as description,m.order_num from sec_user u ");
        ...
        sqlBuffer.append(") tbl order by order_num");
