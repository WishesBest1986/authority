INSERT INTO sec_menu (ID, DESCRIPTION, NAME, PARENT_MENU, ORDER_NUM) VALUES (1, '', '流程管理', NULL, 1);
INSERT INTO sec_menu (ID, DESCRIPTION, NAME, PARENT_MENU, ORDER_NUM) VALUES (2, '', '功能模块', NULL, 2);
INSERT INTO sec_menu (ID, DESCRIPTION, NAME, PARENT_MENU, ORDER_NUM) VALUES (3, '', '配置管理', NULL, 3);
INSERT INTO sec_menu (ID, DESCRIPTION, NAME, PARENT_MENU, ORDER_NUM) VALUES (4, '', '系统管理', NULL, 4);

INSERT INTO sec_menu (ID, DESCRIPTION, NAME, PARENT_MENU, ORDER_NUM) VALUES (11, '', '待办任务', 1, 1);
INSERT INTO sec_menu (ID, DESCRIPTION, NAME, PARENT_MENU, ORDER_NUM) VALUES (12, '', '流程实例', 1, 2);
INSERT INTO sec_menu (ID, DESCRIPTION, NAME, PARENT_MENU, ORDER_NUM) VALUES (13, '', '历史任务', 1, 3);
INSERT INTO sec_menu (ID, DESCRIPTION, NAME, PARENT_MENU, ORDER_NUM) VALUES (14, '', '流程定义', 1, 4);
INSERT INTO sec_menu (ID, DESCRIPTION, NAME, PARENT_MENU, ORDER_NUM) VALUES (15, '', '委托授权', 1, 5);

INSERT INTO sec_menu (ID, DESCRIPTION, NAME, PARENT_MENU, ORDER_NUM) VALUES (31, '', '数据字典', 3, 1);
INSERT INTO sec_menu (ID, DESCRIPTION, NAME, PARENT_MENU, ORDER_NUM) VALUES (32, '', '表单管理', 3, 2);

INSERT INTO sec_menu (ID, DESCRIPTION, NAME, PARENT_MENU, ORDER_NUM) VALUES (41, '', '用户管理', 4, 1);
INSERT INTO sec_menu (ID, DESCRIPTION, NAME, PARENT_MENU, ORDER_NUM) VALUES (42, '', '部门管理', 4, 2);
INSERT INTO sec_menu (ID, DESCRIPTION, NAME, PARENT_MENU, ORDER_NUM) VALUES (43, '', '角色管理', 4, 3);
INSERT INTO sec_menu (ID, DESCRIPTION, NAME, PARENT_MENU, ORDER_NUM) VALUES (44, '', '权限管理', 4, 4);
INSERT INTO sec_menu (ID, DESCRIPTION, NAME, PARENT_MENU, ORDER_NUM) VALUES (45, '', '资源管理', 4, 5);
INSERT INTO sec_menu (ID, DESCRIPTION, NAME, PARENT_MENU, ORDER_NUM) VALUES (46, '', '菜单管理', 4, 6);
...
INSERT INTO sec_user (ID, ENABLED, FULLNAME, PASSWORD, TYPE, USERNAME, ORG, SALT)
VALUES (1, '1', '系统管理员', 'f9e1a0299c2570eb5942fbbda0b2a8ceb2ef9769', '1', 'admin', 200, 'e97e0cea2389225f');
INSERT INTO sec_user (ID, ENABLED, FULLNAME, PASSWORD, TYPE, USERNAME, ORG, SALT)
VALUES (2, '1', 'test', 'f9e1a0299c2570eb5942fbbda0b2a8ceb2ef9769', '1', 'test', 200200, 'e97e0cea2389225f');
INSERT INTO sec_user (ID, ENABLED, FULLNAME, PASSWORD, TYPE, USERNAME, ORG, SALT)
VALUES (3, '1', 'snaker', 'f9e1a0299c2570eb5942fbbda0b2a8ceb2ef9769', '1', 'snaker', 200202, 'e97e0cea2389225f');
